...
class Project(db.Model):
    ...
    name = db.Column(db.String(255), nullable=False, comment="Project name")

    # Description - optional detailed explanation
    description = db.Column(db.Text, nullable=True, comment="Project description")
    ...
    owner_id = db.Column(
        ...
        ),  # Delete project if owner deleted
        nullable=False,
        index=True,
    ...
    start_date = db.Column(db.Date, nullable=True, comment="Project start date")

    end_date = db.Column(db.Date, nullable=True, comment="Project target end date")
    ...
    def add_member(self, user_id, role="MEMBER"):
        ...
        member = ProjectMember(project_id=self.id, user_id=user_id, role=UserRole[role])
    ...
    def is_member(self, user_id):
        ...
        """
        return (
            ProjectMember.query.filter_by(project_id=self.id, user_id=user_id).first()
            is not None
        )
