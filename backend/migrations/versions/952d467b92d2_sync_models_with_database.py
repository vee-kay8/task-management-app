...
def upgrade():
    ...
    with op.batch_alter_table("attachments", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_attachments_task_id"), ["task_id"], unique=False
        )
    ...
    with op.batch_alter_table("project_members", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            ...
            existing_type=postgresql.ENUM(
                "ADMIN", "MANAGER", "MEMBER", "VIEWER", name="user_role"
            ),
        ...
        batch_op.drop_constraint(
            batch_op.f("project_members_project_id_user_id_key"), type_="unique"
        )
        batch_op.create_index(
    ...
    with op.batch_alter_table("tasks", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "idx_task_project_status_position",
        ...
        batch_op.create_index(
            batch_op.f("ix_tasks_reporter_id"), ["reporter_id"], unique=False
        )
...
def downgrade():
    ...
    with op.batch_alter_table("users", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("idx_users_active"), ["is_active"], unique=False
        )
        batch_op.alter_column(
            "last_login",
            existing_type=postgresql.TIMESTAMP(timezone=True),
    ...
    with op.batch_alter_table("tasks", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("idx_tasks_tags"), ["tags"], unique=False, postgresql_using="gin"
        )
        batch_op.create_index(batch_op.f("idx_tasks_status"), ["status"], unique=False)
        batch_op.create_index(
            batch_op.f("idx_tasks_reporter"), ["reporter_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_tasks_project"), ["project_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_tasks_priority"), ["priority"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_tasks_position"),
            ["project_id", "status", "position"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_tasks_due_date"), ["due_date"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_tasks_assignee"), ["assignee_id"], unique=False
        )
        batch_op.alter_column(
            "updated_at",
            existing_type=postgresql.TIMESTAMP(timezone=True),
    ...
    with op.batch_alter_table("projects", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("idx_projects_status"), ["status"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_projects_owner"), ["owner_id"], unique=False
        )
        batch_op.alter_column(
            "updated_at",
            existing_type=postgresql.TIMESTAMP(timezone=True),
    ...
    with op.batch_alter_table("project_members", schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint(
            batch_op.f("project_members_project_id_user_id_key"),
            ["project_id", "user_id"],
        )
        batch_op.create_index(
            batch_op.f("idx_project_members_user"), ["user_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_project_members_project"), ["project_id"], unique=False
        )
        batch_op.alter_column(
            "joined_at",
            existing_type=postgresql.TIMESTAMP(timezone=True),
    ...
    with op.batch_alter_table("comments", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("idx_comments_user"), ["user_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_comments_task"), ["task_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_comments_parent"), ["parent_comment_id"], unique=False
        )
        batch_op.alter_column(
            "created_at",
            existing_type=postgresql.TIMESTAMP(timezone=True),
    ...
    with op.batch_alter_table("attachments", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("idx_attachments_user"), ["uploaded_by"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_attachments_task"), ["task_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["project_id"],
            ["projects.id"],
            name=op.f("activity_log_project_id_fkey"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["task_id"],
            ["tasks.id"],
            name=op.f("activity_log_task_id_fkey"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("activity_log_user_id_fkey"),
            ondelete="CASCADE",
        ),
    ...
    with op.batch_alter_table("activity_log", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("idx_activity_log_user"), ["user_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_activity_log_task"), ["task_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_activity_log_project"), ["project_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_activity_log_created"), ["created_at"], unique=False
        )
